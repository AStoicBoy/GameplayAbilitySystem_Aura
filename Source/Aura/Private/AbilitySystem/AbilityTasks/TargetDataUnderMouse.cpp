...
void UTargetDataUnderMouse::Activate()
{
	...
	else
	{
		...
		const bool bCalledDelegate = AbilitySystemComponent.Get()->CallReplicatedTargetDataDelegatesIfSet(SpecHandle, ActivationPredicate);
		if (bCalledDelegate)
		{
...
{
	FScopedPredictionWindow ScopedPrediction(AbilitySystemComponent.Get()); // Everything within this scope should be predicted
